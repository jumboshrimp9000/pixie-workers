...
- `pixie-google-free-nonprofit-worker` runs `main_nonprofit.py` and owns `free_google_provision`, `free_google_cancel_domain`, `google_recovery_move`, and `google_recovery_purge`.
...
- `NONPROFIT_GOOGLE_ACTION_TYPES=free_google_provision,free_google_cancel_domain,google_recovery_move,google_recovery_purge`
